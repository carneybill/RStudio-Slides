...
subtitle: Dave Hurst, Tareef Kawaf, Nathan Stephens
output:
...
.large[
- RStudio Community - [rstudio.link/community](http://rstudio.link/community)
- Developer Blog - [rstudio.link/developer_blog](http://rstudio.link/developer_blog)
- R Views Blog - [rstudio.link/rviews_blog](http://rstudio.link/rviews_blog)
- TensorFlow Blog - [rstudio.link/tensorflow_blog](http://rstudio.link/tensorflow_blog)
- Twitter - [rstudio.link/twitter](http://rstudio.link/twitter)
- GitHub - [rstudio.link/github](http://rstudio.link/github)
- LinkedIn - [rstudio.link/linkedin](http://rstudio.link/linkedin) 
- YouTube - [rstudio.link/youtube](http://rstudio.link/youtube)
- Facebook - [rstudio.link/facebook](http://rstudio.link/facebook)
]